...
Одной из наиболее трудозатратных частей при написании тестов — написание кода для
...
фикстура повторно использовалась, а код, который создаёт её.
...
-
  ...
  другой тестовый класс. Назовите класс после разницы в настройке.
